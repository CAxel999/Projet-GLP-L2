...
public class Car extends MobileElement{
    ...
    public boolean hasStopped() {return true;}

	public TurnSignal getTurnSignal() {return turnSignal;}

	public void setTurnSignal(TurnSignal turnSignal) {this.turnSignal = turnSignal;}

	public void setTurnLeft(boolean state) {
		turnSignal.setTurnLeft(state);
	}

	public void setTurnRight(boolean state) {
		turnSignal.setTurnRight(state);
	}
